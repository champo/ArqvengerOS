...
\section{Diseño del Kernel}
    ...
    \subsection{Segmentacion y paginacion}
        El SO no utiliza ni segmentacion ni paginacion. 
        Es decir, utilizamos modo flat, sin paginacion.
        La configuracion de segmentos en modo flat, viene provista por GRUB.
        El mismo crea 2 segmentos, uno de codigo, y otro de datos.
        Estos ocupan toda la extension del mapa de memoria.
    ...
    \subsection{Terminales}
        ...
        \subsubsection{Salida}
            ...
            El listado de las mismas esta en la documentacion del driver de video.
