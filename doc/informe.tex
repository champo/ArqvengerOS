...
Algunos de estos comandos estan atados de forma directa a ciertas llamadas a sistema.
	...
	% top.png: 723x477 pixel, 96dpi, 19.13x12.62 cm, bb=0 0 542 358
	...
	% ls.png: 725x475 pixel, 96dpi, 19.18x12.57 cm, bb=0 0 544 356
	...
	\end{center}
     ...
     \begin{figure}[H]
      ...
      % help.png: 719x477 pixel, 96dpi, 19.02x12.62 cm, bb=0 0 539 358
     ...
     \begin{figure}[H]
      ...
      % sudoku.png: 725x475 pixel, 96dpi, 19.18x12.57 cm, bb=0 0 544 356
     ...
     \begin{figure}[H]
      ...
      % login.png: 722x478 pixel, 96dpi, 19.10x12.65 cm, bb=0 0 541 358
     ...
     \begin{figure}[H]
      ...
      % roflcopter.png: 719x475 pixel, 96dpi, 19.02x12.57 cm, bb=0 0 539 356
