...
\section{Librería estándar}
    Para poder realizar nuestro sistema operativo, era necesario implementar cierta funcionalidad de la librería estándar de C. Al hacerlo, respetamos, siempre que fuese posible, las definiciones y las funcionalidades presentadas por el estándar \texti{ANSI}.
    ...
    Nuestra librería estándar incluye: funciones para el control del tipo de datos (\texit{isdigit}, \texit{isspace}, \texit{islower}, \texit{isupper}, \texit{isalpha} y \texit{isalnum}), funciones para entrada y salida de texto (\texit{fputc}, \texit{putc}, \texit{putchar}, \texit{puts}, \texit{fputs}, \texit{vfprinf}, \texit{vprintf}, \texit{fprintf}, \texit{printf}, \texit{fgetc}, \texit{getc}, \texit{getchar}, \texit{vfscanf}, \texit{vscanf}, \texit{fscanf} y \texit{scanf}), funciones para conversión de numeros a texto y viceversa (\texit{itoa}, \texit{atoi}, \texit{utoa} y \texit{atou}), generación de numeros al azar (\texit{rand} y \texit{srand}), manejo de cadenas de caracteres(\texit{strlen}, \texit{strcpy}, \texit{strncpy}, \texit{strcmp}, \texit{strncmp}, \texit{strchr}, \texit{strrchr}, \texit{strcat}, \texit{strncat}, \texit{reverse}), cierto manejo de sectores en memoria(\texit{memcpy}, \texit{memchr}, \texit{memset}, \texit{memcmp}), acceso simple al reloj para obtener el tiempo, manejo de argumentos variables y la definición de ciertas constantes necesarias.
